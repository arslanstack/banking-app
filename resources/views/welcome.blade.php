...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('assets/landing/css/elegant-icons.min.css')}}" media="all" />
	<link rel="stylesheet" type="text/css" href="{{asset('assets/landing/css/all.min.css')}}" media="all" />
	<link rel="stylesheet" type="text/css" href="{{asset('assets/landing/css/animate.css')}}" media="all" />
	<link rel="stylesheet" type="text/css" href="{{asset('assets/landing/css/slick.css')}}" media="all" />
	<link rel="stylesheet" type="text/css" href="{{asset('assets/landing/css/slick-theme.css')}}" media="all" />
	<link rel="stylesheet" type="text/css" href="{{asset('assets/landing/css/nice-select.css')}}" media="all" />
	<link rel="stylesheet" type="text/css" href="{{asset('assets/landing/css/animate.css')}}" media="all" />
	<link rel="stylesheet" type="text/css" href="{{asset('assets/landing/css/default.css')}}" media="all" />
	<link rel="stylesheet" type="text/css" href="{{asset('assets/landing/css/style.css')}}" media="all" />
	<link rel="stylesheet" type="text/css" href="{{asset('assets/landing/css/responsive.css')}}" media="all" />
</head>
<body>
	<!-- Preloader -->
	<div id="preloader">
		<div id="ctn-preloader" class="ctn-preloader">
			<div class="round_spinner">
				...
				<div class="text">
					<img src="{{asset('assets/landing/img/logo/Logo-2.png')}}" alt="">
				</div>
			</div>
			...
			<nav class="navbar navbar-expand-lg ">
				<div class="container">
					<a class="navbar-brand sticky_logo" href="index.html">
						<img class="main" src="{{asset('assets/landing/img/logo/Logo.png')}}" srcset="{{asset('assets/landing/img/logo/Logo@2x.png')}} 2x" alt="logo">
						<img class="sticky" src="{{asset('assets/landing/img/logo/Logo-3.png')}}" srcset="{{asset('assets/landing/img/logo/Logo-3@2x.png')}} 2x" alt="logo">
					</a>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
							...
							<li class="nav-item dropdown submenu ">
								...
								<i class="arrow_carrot-down_alt2 mobile_dropdown_icon" aria-hidden="true"
								 ...
								 <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a href="index-app.html" class="nav-link active">Mobile App</a>
                                    </li>
						...
						<a class="theme-btn theme-btn-rounded-2" href="#">Download</a>
	...
	<main>
		...
		<section class="banner-area" id="banner_animation">
			...
			<div class="logos">
				<img src="{{asset('assets/landing/img/banner/Logo-1.png')}}" alt="social">
				<img src="{{asset('assets/landing/img/banner/Logo-2.png')}}" alt="social">
				<img src="{{asset('assets/landing/img/banner/Logo-3.png')}}" alt="social">
				<img src="{{asset('assets/landing/img/banner/Logo-4.png')}}" alt="social">
				<img src="{{asset('assets/landing/img/banner/Logo-5.png')}}" alt="social">
				<img src="{{asset('assets/landing/img/banner/Logo-6.png')}}" alt="social">
			</div>
			<div class="container">
				<div class="row">
					<div class="col-lg-10 mx-auto">
						<div class="banner-content text-center pt-200">
							<h1>Simple and Safe Digital <br /> Banking Mobile App</h1>
							<div class="img-area mt-35">
								<img class="img-fluid" data-depth="0.6" src="{{asset('assets/landing/img/banner/person.png')}}" alt="person">
							</div>
							...
							<div class="row text-center gy-2 gy-lg-0">
								<div class="col-lg-3 col-6">
									<div class="statistics-widget-1 text-start pt-10">
										<img src="{{asset('assets/landing/img/banner/icon-1.svg')}}" alt="icon">
										<p>Active user</p>
										<h2 class="counter"><span>15,000</span></h2>
									</div>
								</div>

								<div class="col-lg-3 col-6">
									<div class="statistics-widget-1 text-start pt-10">
										<img src="{{asset('assets/landing/img/banner/icon-2.svg')}}" alt="icon">
										<p>download</p>
								...
								<div class="col-lg-3 col-6">
									<div class="statistics-widget-1 text-start pt-10">
										<img src="{{asset('assets/landing/img/banner/icon-3.svg')}}" alt="icon">
										<p>reviews</p>
										<h2 class="counter"><span>35.7</span>k</h2>
									</div>
								</div>
								<div class="col-lg-3 col-6">
									<div class="statistics-widget-1 text-start pt-10">
										<img src="{{asset('assets/landing/img/banner/icon-4.svg')}}" alt="icon">
										<p>partners</p>
				...
				<div class="row gy-xl-0 gy-4">
					<div class="col-xl-3 col-md-6">
						<div class="feature-card-widget wow fadeInUp">
							<div class="card-img">
								<img src="{{asset('assets/landing/img/feature/icon-1.svg')}}" alt="feature svg">
							</div>
							<h4>Prepaid Card</h4>
					...
					<div class="col-xl-3 col-md-6">
						<div class="feature-card-widget wow fadeInUp" data-wow-delay="0.3s">
							<div class="card-img">
								<img src="{{asset('assets/landing/img/feature/icon-2.svg')}}" alt="feature svg">
							</div>
							<h4>Easy to use</h4>
					...
					<div class="col-xl-3 col-md-6">
						<div class="feature-card-widget wow fadeInUp" data-wow-delay="0.6s">
							<div class="card-img">
								<img src="{{asset('assets/landing/img/feature/icon-3.svg')}}" alt="feature svg">
							</div>
					...
					<div class="col-xl-3 col-md-6">
						<div class="feature-card-widget wow fadeInUp" data-wow-delay="0.9s">
							<div class="card-img">
								<img src="{{asset('assets/landing/img/feature/icon-4.svg')}}" alt="feature svg">
							</div>
							<h4>pay bill</h4>
				...
				<div class="row gy-lg-0 gy-4 pb-10">
					<div class="col-md-6 mx-auto">
						<div class="img-content">
							<img class="bg-img" src="{{asset('assets/landing/img/track-progress/shape-bg.png')}}" alt="">
							<img class="track-3 wow fadeInUp" src="{{asset('assets/landing/img/track-progress/track-1.png')}}" alt="">
							<img class="track-img track-1 wow fadeInRight" data-wow-delay="0.3s"
								src="{{asset('assets/landing/img/track-progress/track-2.png')}}" alt="">
							<img class="track-img track-2 wow fadeInRight" data-wow-delay="0.5s"
								src="{{asset('assets/landing/img/track-progress/track-3.png')}}" alt="">
						</div>
					</div>
			...
			<div class="container">
				<div class="row gy-lg-0 gy-4">
					...
					<div class="col-md-6 mx-auto offset-xl-1 order-1 order-lg-2">
						<div class="img-content">
							<img class="bg-img" src="{{asset('assets/landing/img/card-payment/shape-bg.png')}}" alt="">
							<img class="card-1 img-fluid wow fadeInLeft" src="{{asset('assets/landing/img/card-payment/card-1.png')}}" alt="">
							<img class="card-2 wow fadeInLeft" data-wow-delay="0.3s" src="{{asset('assets/landing/img/card-payment/card-2.png')}}"
								alt="">
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row gy-lg-0 gy-4">
					<div class="col-md-6 mx-auto mx-lg-0 text-center">
						<div class="img-content">
							<img class="bg-img" src="{{asset('assets/landing/img/internet-banking/shape-bg.png')}}" alt="">
							<img class="bank-main img-fluid wow fadeInUp" src="{{asset('assets/landing/img/internet-banking/img-1.png')}}" alt="">
							<img class="bank-1 img-fluid wow fadeInRight" data-wow-delay="0.3s"
								src="{{asset('assets/landing/img/internet-banking/img-2.png')}}" alt="">
							<img class="bank-2 img-fluid wow fadeInLeft" data-wow-delay="0.6s"
								src="{{asset('assets/landing/img/internet-banking/img-3.png')}}" alt="">
							<img class="bank-3 img-fluid wow fadeInRight" data-wow-delay="0.8s"
								src="{{asset('assets/landing/img/internet-banking/info.png')}}" alt="">
						</div>
					</div>
					...
					<div class="col-xl-6">
						<div class="single-security-widget wow fadeInUp">
							<div class="security-img text-center">
								<img class="img-fluid round-15" src="{{asset('assets/landing/img/security-tips/img-1.png')}}" alt="security image">
							</div>
					...
					<div class="col-xl-6">
							...
							<div class="row align-items-center">
								<div class="col-4">
									<div class="security-img h-100">
										<img class="img-fluid round-10 h-100" src="{{asset('assets/landing/img/security-tips/img-2.png')}}"
											alt="security image">
									</div>
								</div>
								<div class="col-8">
						...
						<div class="single-security-widget mt-25 mt-lg-30 wow fadeInRight" data-wow-delay="0.4s">
							<div class="row">
								...
								<div class="col-5">
									<div class="security-img h-100">
										<img class="img-fluid round-10 h-100" src="{{asset('assets/landing/img/security-tips/img-3.png')}}"
											alt="security image">
									</div>
								</div>
							</div>
			...
			<div class="container">
				...
				<div class=" client-slider pt-45 pb-140">
					<div class="single-client wow fadeInUp" data-wow-delay="0.1s">
						<img class="img-fluid rounded-circle" src="{{asset('assets/landing/img/client/client-1.png')}}" alt="cleint">
					...
					<div class="single-client wow fadeInUp" data-wow-delay="0.3s">
						<img class="img-fluid rounded-circle" src="{{asset('assets/landing/img/client/client-2.png')}}" alt="cleint">
						<p class="quote">Assertively procrastinate distributed relationships whereas equity invested
							intellectual capital
							everything</p>
						<div class="client-info">
					...
					<div class="single-client wow fadeInUp" data-wow-delay="0.5s">
						<img class="img-fluid rounded-circle" src="{{asset('assets/landing/img/client/client-3.png')}}" alt="cleint">
						<p class="quote">Assertively procrastinate distributed relationships whereas equity invested
							intellectual capital
							everything</p>
						<div class="client-info">
				...
				<div class="row pt-110">
					<div class="col-md-12 position-relative">
						<div class="cta cta-2" style="background-image: url({{asset('assets/landing/img/client/cta-bg.png')}});">
							<div class="bubbles">
		...
		<section class="news-area pt-200 pb-110">
			<div class="container ">
				<div class="section-title pt-30">
					<h2 class="wow fadeInUp">Banca Latest News</h2>
				</div>

				<div class="news-slider  pt-30 ">
					<div class="blog-widget-1 wow fadeInUp" data-wow-delay="0.1s">
						<img class="w-sm-auto w-100" src="{{asset('assets/landing/img/blog/news-1.png')}}" alt="news image">
					...
					<div class="blog-widget-1 wow fadeInUp" data-wow-delay="0.3s">
						<img class="w-sm-auto w-100" src="{{asset('assets/landing/img/blog/news-2.png')}}" alt="news image">
					...
					<div class="blog-widget-1 wow fadeInUp" data-wow-delay="0.5s">
						<img class="w-sm-auto w-100" src="{{asset('assets/landing/img/blog/news-3.png')}}" alt="news image">
					...
					<div class="col-xl-4 col-lg-3 col-6 pr-lg-90">
						<div class="footer-widget mb-30 wow fadeInLeft">
							<div class="flog mb-35">
								<a href="index.html"><img src="{{asset('assets/landing/img/logo/Logo.png')}}" alt="logo"></a>
							</div>
	...
	<!-- JS here -->
	<script type="text/javascript" src="{{asset('assets/landing/js/jquery-3.6.0.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('assets/landing/js/preloader.js')}}"></script>
	<script type="text/javascript" src="{{asset('assets/landing/js/bootstrap.bundle.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('assets/landing/js/jquery.smoothscroll.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('assets/landing/js/jquery.waypoints.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('assets/landing/js/jquery.counterup.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('assets/landing/js/jquery.nice-select.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('assets/landing/js/slick.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('assets/landing/js/parallax.js')}}"></script>
	<script type="text/javascript" src="{{asset('assets/landing/js/jquery.parallax-scroll.js')}}"></script>
